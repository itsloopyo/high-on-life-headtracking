// Runs core's canonical config lint over config/HeadTracking.ini, the committed
// file, and over every distinct CameraUnlock.ini the differential test migrated
// (the folder it names as the argument).
//
